...
import { calculateHeight, calculateWidth, getValue } from "@/theme/utils";
...
function Dashboard({ navigation }: ApplicationScreenProps) {
  ...
  const [isInternetReachable, setIsInternbetReachable] = useState(true);
  ...
  console.log(Math.round(parseFloat(trueHeadingHdt) * 10) / 10);
